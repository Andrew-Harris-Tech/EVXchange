...
class TestUserModel:
    ...
    def test_user_creation(self, app):
        ...
        with app.app_context():
            user = User(
                email="test@example.com", name="Test User", google_id="123456789"
            )
            db.session.add(user)
            db.session.commit()
    ...
    def test_find_by_oauth_id_google(self, app):
        ...
        with app.app_context():
            user = User(
                email="test@example.com", name="Test User", google_id="google123"
            )
            db.session.add(user)
            db.session.commit()
    ...
    def test_find_by_oauth_id_facebook(self, app):
        ...
        with app.app_context():
            user = User(
                email="test@example.com", name="Test User", facebook_id="facebook123"
            )
            db.session.add(user)
            db.session.commit()
    ...
    def test_find_by_oauth_id_linkedin(self, app):
        ...
        with app.app_context():
            user = User(
                email="test@example.com", name="Test User", linkedin_id="linkedin123"
            )
            db.session.add(user)
            db.session.commit()
    ...
    def test_unique_oauth_ids(self, app):
        ...
        with app.app_context():
            user1 = User(
                email="user1@example.com", name="User 1", google_id="google123"
            )
            user2 = User(
                email="user2@example.com", name="User 2", google_id="google123"
            )
