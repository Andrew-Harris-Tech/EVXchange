...
class TestGoogleOAuthProvider:
    ...
    def test_get_authorization_url(self):
        ...
        assert f"redirect_uri={redirect_uri}" in auth_url.replace("%3A", ":").replace(
            "%2F", "/"
        )
...
class TestFacebookOAuthProvider:
    ...
    def test_get_user_info_success(self):
        ...
        mock_user_data = {
            ...
            "picture": {"data": {"url": "https://facebook.com/picture.jpg"}},
        }
...
class TestLinkedInOAuthProvider:
    ...
    def test_get_user_info_success(self):
            ...
            "profilePicture": {
                "displayImage~": {
                    "elements": [
                        {
                            "identifiers": [
                                {"identifier": "https://linkedin.com/pic.jpg"}
                            ]
                        }
                    ]
                }
        ...
        # Mock email response
        email_data = {
            "elements": [{"handle~": {"emailAddress": "john.doe@linkedin.com"}}]
        }
